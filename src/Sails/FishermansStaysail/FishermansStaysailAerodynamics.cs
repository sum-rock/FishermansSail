...
{
    internal struct FishermansStaysailWindFrame
    {
    ...
    internal static class FishermansStaysailAerodynamics
    {
        ...
        internal static bool TryFrame(
            ...
            Vector3 aftHead,
            Vector3 clew,
            out FishermansStaysailWindFrame frame
        )
        {
            frame = default;
            ...
            if (first + second < 1e-8f)
                return false;
            frame = new FishermansStaysailWindFrame
            {
                AlongSail = chord,
                MastAxis = mast,
