    ...
    internal static class FishermansStaysailMkA
    {
        ...
        internal static void Register(PrefabsDirectory directory)
        {
            ...
            try
            {
                ...
                var geometry = FishermansStaysailMkAGeometry.Create(sourceSail.installHeight);
                ...
                container = new GameObject("FishermansStaysailMkA Prefabs");
                ...
                mesh = new Mesh { name = "FishermansStaysailMkA Trapezoid Cloth" };
                ...
                shadowMesh = new Mesh { name = "FishermansStaysailMkA Shadow Samples" };
                ...
                clone.AddComponent<FishermansStaysailMkAShape>();
                ...
                string registrationMessage =
                    ...
                    + $"vertices={mesh.vertexCount}, corners=4, luffAngles=110, pinnedLuff=true, "
